...
export class GroupAreaNodeTenta<
...
> extends Tenta.Focusable<TRestStateEx>
{
	...
	override use(cfg?: GroupAreaNodeTenta.UseConfig)
	{
	...
	override created()
	{
		...
		{
			this.rootFfRef = parentTenta instanceof GroupAreaNodeTenta ? parentTenta.rootFfRef || null : null;
		}
...
export module GroupAreaNodeTenta
{
