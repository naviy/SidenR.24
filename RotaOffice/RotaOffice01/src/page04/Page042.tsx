...
function UnitNode({ db, r, ...props }: Pile.Node2Props & { db: DB, r: Unit })
{
	return <Pile.Node2 id={r.id} {...props} rowEnd="collapsed">
...
function UnitSubordinations({ db, r }: { db: DB, r: Unit })
{
	...
	return (
		...
		<Pile.Col collapsed="collapsed" indent="opened" start="opened" end wrapperCls="pb0">

			<Pile.Node2 start end linkLine="opened" maxPhase={hasMasters && hasSubunits ? 2 : 1}>
...
function UnitMasterNode({ db, r, ...props }: { db: DB, r: Unit_Subordination } & Pile.Node2Props)
{

	return <Pile.Node2 id={r.id} {...props}>
...
function UnitSubunitNode({ db, r, ...props }: { db: DB, r: Unit_Subordination } & Pile.Node2Props)
{
