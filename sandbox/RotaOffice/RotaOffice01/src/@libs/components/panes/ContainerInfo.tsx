...
export module ContainerInfo
{
	...
	): ContainerInfo
	{
		...
		let { ppStart, pp, ppx, ppy } = props;
		v.ppl = (!ppStart && (inCol || start) ? parentInfo.ppl || 0 : 0) + (props.ppl ?? ppx ?? pp ?? 0);
		v.ppr = (!ppStart && (inCol || end) ? parentInfo.ppr || 0 : 0) + (props.ppr ?? ppx ?? pp ?? 0);
		v.ppt = (!ppStart && (inRow || start) ? parentInfo.ppt || 0 : 0) + (props.ppt ?? ppy ?? pp ?? 0);
		v.ppb = (!ppStart && (inRow || end) ? parentInfo.ppb || 0 : 0) + (props.ppb ?? ppy ?? pp ?? 0);

		let { pp0, ppx0, ppy0 } = props;
		v.ppl0 = (!ppStart && (inCol || start) ? parentInfo.ppl0 || 0 : 0) + (props.ppl0 ?? ppx0 ?? pp0 ?? 0);
		v.ppr0 = (!ppStart && (inCol || end) ? parentInfo.ppr0 || 0 : 0) + (props.ppr0 ?? ppx0 ?? pp0 ?? 0);
		v.ppt0 = (!ppStart && (inRow || start) ? parentInfo.ppt0 || 0 : 0) + (props.ppt0 ?? ppy0 ?? pp0 ?? 0);
		v.ppb0 = (!ppStart && (inRow || end) ? parentInfo.ppb0 || 0 : 0) + (props.ppb0 ?? ppy0 ?? pp0 ?? 0);
